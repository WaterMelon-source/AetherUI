...
function Components:BuildLabel(parent: Frame, title: string): Frame
	local labelContainer = createInstance("Frame", parent, {
		Name = "Label", AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.34036, 0, 1, 0), Position = UDim2.new(0.17018, 0, 0.5, 0),
		BackgroundTransparency = 1,
	})
	createInstance("UIListLayout", labelContainer, {
		HorizontalAlignment = Enum.HorizontalAlignment.Center,
		Padding = UDim.new(0.01, 0), VerticalAlignment = Enum.VerticalAlignment.Center,
		SortOrder = Enum.SortOrder.LayoutOrder, ItemLineAlignment = Enum.ItemLineAlignment.Start,
	})
	createInstance("TextLabel", labelContainer, {
		Name = "Title", TextWrapped = true, TextSize = 14,
		...
		Size = UDim2.new(1, 0, 0.5, 0), Text = title,
	})
...
function Components:BuildButton(parent: Frame, title: string, description: string, buttonText: string, callback: (() -> ())?): Frame
	local buttonContainer = createInstance("Frame", parent, {
		...
		Size = UDim2.new(1, 0, 0.1, 0), Position = UDim2.new(0.5, 0, 0.5, 0),
		BackgroundTransparency = 1,
	})
	...
	local textFrame = createInstance("Frame", buttonContainer, {
		Name = "Frame", AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.34036, 0, 1, 0), Position = UDim2.new(0.17018, 0, 0.5, 0),
		BackgroundTransparency = 1,
	})
	...
	createInstance("TextLabel", textFrame, {
		Name = "1Title", TextWrapped = true, TextSize = 14,
		TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Medium, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextPrimary, BackgroundTransparency = 1,
		Size = UDim2.new(1, 0, 0.32, 0), Text = title,
	})
	createInstance("TextLabel", textFrame, {
		Name = "2Description", TextWrapped = true, TextSize = 12,
		TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Medium, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextSecondary, BackgroundTransparency = 1,
		Size = UDim2.new(1, 0, 0.3, 0), Text = description,
		Position = UDim2.new(0, 0, 0, 20),
	})
	
	local actionBtn = createInstance("TextButton", buttonContainer, {
		Name = "Button", TextWrapped = true, BorderSizePixel = 0, TextSize = 12,
		AutoButtonColor = false, TextScaled = true, TextColor3 = THEME.TextPrimary,
	...
	createInstance("UIStroke", actionBtn, {
		Thickness = 1.6, Color = THEME.StrokeColor,
		ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
	})
	createInstance("TextLabel", actionBtn, {
		Name = "Text", TextWrapped = true, TextSize = 12, TextScaled = true,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Regular, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextPrimary, BackgroundTransparency = 1,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.8, 0, 0.8, 0),
		Text = buttonText, Position = UDim2.new(0.5, 0, 0.5, 0),
	})
...
function Components:BuildSlider(parent: Frame, title: string, description: string, min: number, max: number, default: number, callback: ((number) -> ())?): Frame
	...
	local sliderTrack = createInstance("Frame", sliderContainer, {
		Name = "Slider", BorderSizePixel = 0, BackgroundColor3 = THEME.SliderTrack,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.1754, 0, 0.1, 0),
	...
	local fill = createInstance("Frame", sliderTrack, {
		Name = "Value", BorderSizePixel = 0, BackgroundColor3 = THEME.SliderFill,
		Size = UDim2.new(0, 0, 1, 0),
	})
	createInstance("UICorner", fill, { CornerRadius = UDim.new(1, 0) })
	
	local knob = createInstance("Frame", sliderTrack, {
		Name = "Circle", BorderSizePixel = 0, BackgroundColor3 = THEME.TextPrimary,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(2.5, 0, 2.5, 0),
...
function Components:BuildToggle(parent: Frame, title: string, description: string, callback: ((boolean) -> ())?): Frame
	local toggleContainer = createInstance("Frame", parent, {
		Name = "Toggle", AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(1, 0, 0.1, 0), Position = UDim2.new(0.5, 0, 0.5, 0),
		BackgroundTransparency = 1,
	})
	...
	local switch = createInstance("Frame", toggleContainer, {
		Name = "Switch", BorderSizePixel = 0, BackgroundColor3 = THEME.ToggleOff,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.085, 0, 0.5, 0),
		Position = UDim2.new(0.9, 0, 0.5, 0),
	})
	...
	local circle = createInstance("Frame", switch, {
		Name = "Circle", BorderSizePixel = 0, BackgroundColor3 = THEME.TextPrimary,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.7, 0, 0.7, 0),
...
function Window.new(title: string, description: string): table
	...
	local screenGui = createInstance("ScreenGui", CoreGui, {
		Name = "AetherUI", ZIndexBehavior = Enum.ZIndexBehavior.Sibling, Enabled = false,
	})
	
	local window = createInstance("Frame", screenGui, {
		Name = "Window", ZIndex = 10, BorderSizePixel = 0,
		BackgroundColor3 = THEME.WindowBackground, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.48, 0, 0.5, 0), Position = UDim2.new(0.5, 0, 0.5, 0),
	...
	local side = createInstance("Frame", window, {
		...
		BackgroundColor3 = THEME.SideBackground, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.25, 0, 0.95, 0), Position = UDim2.new(0.14, 0, 0.5, 0),
		BackgroundTransparency = 0.25,
	})
	createInstance("UICorner", side, { CornerRadius = UDim.new(0.05, 0) })
	createInstance("UIStroke", side, {
		Color = THEME.StrokeColor, ApplyStrokeMode = Enum.ApplyStrokeMode.Border,
	})
	
	local decor = createInstance("Frame", side, {
		Name = "Decor", ZIndex = 2, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.2, 0, 0.028, 0), Position = UDim2.new(0.18, 0, 0.04, 0),
		BackgroundTransparency = 1,
	})
	...
	for _, data in ipairs(decorData) do
		local dot = createInstance("Frame", decor, {
			BorderSizePixel = 0, BackgroundColor3 = data.color,
			AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(1, 0, 1, 0),
			Position = data.pos, Name = data.name,
		})
	...
	local tabsContainer = createInstance("Frame", side, {
		...
		BackgroundColor3 = THEME.TabsBackground, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.9, 0, 0.9, 0), Position = UDim2.new(0.5, 0, 0.53, 0),
		BackgroundTransparency = 1,
	})
	...
	createInstance("TextLabel", tabsContainer, {
		Name = "Category", TextWrapped = true, TextSize = 12,
		TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Medium, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextSecondary, BackgroundTransparency = 1,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(1, 0, 0.035, 0),
		Text = "Category", Position = UDim2.new(0.5, 0, 0.5, 0),
	})
	
	local main = createInstance("Frame", window, {
		Name = "Main", ZIndex = 10, BorderSizePixel = 0,
		BackgroundColor3 = THEME.MainPlaceholder, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.70556, 0, 0.95119, 0), Position = UDim2.new(0.63137, 0, 0.4994, 0),
		BackgroundTransparency = 1,
	})
	createInstance("UICorner", main, { CornerRadius = UDim.new(0.01, 25) })
	
	local labels = createInstance("Frame", main, {
		Name = "Labels", ZIndex = 2, AnchorPoint = Vector2.new(0.5, 0.5),
		Size = UDim2.new(0.9, 0, 0.075, 0), Position = UDim2.new(0.5, 0, 0.05, 0),
		BackgroundTransparency = 1,
	})
	...
	local titleLabel = createInstance("TextLabel", labels, {
		...
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Bold, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextPrimary, BackgroundTransparency = 1,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(1, 0, 0.4, 0),
		Text = title, Position = UDim2.new(0.5, 0, 0.25, 0),
	})
	
	createInstance("TextLabel", labels, {
		Name = "2Description", TextWrapped = true, ZIndex = 2, TextSize = 10,
		TextXAlignment = Enum.TextXAlignment.Left, TextScaled = true,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Medium, Enum.FontStyle.Normal),
		TextColor3 = THEME.TextSecondary, BackgroundTransparency = 1,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.2961, 0, 0.3, 0),
		Text = description, Position = UDim2.new(0.14805, 0, 0.9, 0),
	})
	
	createInstance("UIListLayout", labels, {
		HorizontalAlignment = Enum.HorizontalAlignment.Center,
		Padding = UDim.new(0.1, 0), VerticalAlignment = Enum.VerticalAlignment.Center,
		SortOrder = Enum.SortOrder.LayoutOrder, ItemLineAlignment = Enum.ItemLineAlignment.Start,
	})
	
	local scrollingFrame = createInstance("ScrollingFrame", main, {
		BorderSizePixel = 0, CanvasSize = UDim2.new(0, 0, 0, 500),
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.97246, 0, 0.86448, 0),
		Position = UDim2.new(0.53623, 0, 0.54276, 0), ScrollBarImageColor3 = THEME.ScrollBar,
	...
	createInstance("UIPadding", scrollingFrame, {
		PaddingTop = UDim.new(0.025, 0), PaddingRight = UDim.new(0.05, 0),
...
function Window:AddTab(name: string, iconId: string?): table
	...
	local tabButton = createInstance("TextButton", tabBtn, {
		Name = "Button", BorderSizePixel = 0, TextXAlignment = Enum.TextXAlignment.Left,
		TextSize = 12, TextColor3 = THEME.TextPrimary, BackgroundColor3 = THEME.TabBackground,
		FontFace = getFont(FONT_PATH, Enum.FontWeight.Bold, Enum.FontStyle.Normal),
		ZIndex = 5, AnchorPoint = Vector2.new(0.5, 0.5), BackgroundTransparency = 1,
	...
	if iconId then
		local icon = createInstance("ImageLabel", tabBtn, {
			Name = "Icon", BorderSizePixel = 0, BackgroundColor3 = Color3.fromRGB(255, 255, 255),
			AnchorPoint = Vector2.new(0.5, 0.5), Image = "rbxassetid://" .. tostring(iconId):gsub("[^%d]", ""),
			Size = UDim2.new(0.65, 0, 0.65, 0), BorderColor3 = Color3.fromRGB(0, 0, 0),
			BackgroundTransparency = 1, Position = UDim2.new(0.12, 0, 0.5, 0),
		})
	...
	createInstance("TextLabel", tabBtn, {
		...
		TextColor3 = THEME.TextPrimary, BackgroundTransparency = 1,
		AnchorPoint = Vector2.new(0.5, 0.5), Size = UDim2.new(0.55, 0, 0.55, 0),
		Text = name, Position = UDim2.new(iconId and 0.49 or 0.1, 0, 0.5, 0),
	})
